...
function __flag($flag){
    if($flag == 1){
        ...
        $hasil = '<span class="label label-info" title="Admin Stock">Perencana</label>';
    }elseif($flag == 3){
        $hasil = '<span class="label label-info" title="Admin Pengadaan">Pengada</label>';
    }elseif($flag == 4){
        ...
        $hasil = '<span class="label label-info"> Supplier</label>';
    }
    return $hasil;
}
